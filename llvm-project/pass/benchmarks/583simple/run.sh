...
PATH_MYPASS=~/eecs583-project/llvm-project/pass/build/Superblock/LLVMPJT.so ### Action Required: Specify the path to your pass ###
NAME_MYPASS=-Superblock ### Action Required: Specify the name for your pass ###
BENCH=src/${1}.c
INPUT=${2}
